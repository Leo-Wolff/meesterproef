const realityData = {
	0: {
		taskDescription:
			"Write an email to teacher for clarification on the assignment.",
		taskText:
	...
	1: {
		taskDescription: "Reply to teacher’s email.",
		taskText:
	...
	2: {
		taskDescription: "Read and summarise chapter 4.",
		taskText:
	...
	3: {
		taskDescription: "Prepare questions for meeting.",
		taskText:
	...
	4: {
		taskDescription: "Message tutor about elective.",
		taskText:
	...
	7: {
		taskDescription: "Update assignment log.",
		taskText:
			"For my resit, I wanted to make the assignment easier for myself. From the start of the course, I noticed that I was struggling with my chosen subject all the time. \n \n To avoid having to start all over again, I will still focus on books, but with a different direction. With this train of thought I noticed Rick Riordan: my favorite author.",
	},
}
